...
-(id) init
{
    ...
    if (self != nil)
    {
        ...
        monster.character=[CCSprite spriteWithFile:@"Maya_3.png"];   
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Maya_3.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"maya000.png"];
        frame2 = [framecache spriteFrameByName:@"maya001.png"];
        frame3= [framecache  spriteFrameByName:@"maya002.png"];
        frame4 = [framecache spriteFrameByName:@"maya003.png"];
        frame5 = [framecache spriteFrameByName:@"maya004.png"];
        frame6 = [framecache spriteFrameByName:@"maya005.png"];
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Harpy_3.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Harpy_3.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"harpy000.png"];
        frame2 = [framecache spriteFrameByName:@"harpy001.png"];
        frame3= [framecache  spriteFrameByName:@"harpy002.png"];
        frame4 = [framecache spriteFrameByName:@"harpy003.png"];
        frame5 = [framecache spriteFrameByName:@"harpy004.png"];

        frame6 = [framecache spriteFrameByName:@"harpy005.png"];
        frame11 = [framecache spriteFrameByName:@"harpy006.png"];
        frame12 = [framecache spriteFrameByName:@"harpy007.png"];
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Bat_3.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Bat_3.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"bats1_2.png"];
        frame3= [framecache  spriteFrameByName:@"bats3_2.png"];
        frame4 = [framecache spriteFrameByName:@"bats4_2.png"];
        frame5 = [framecache spriteFrameByName:@"bats5_2.png"];
        frame6 = [framecache spriteFrameByName:@"bats6_2.png"];
        ...
        [ a_monsters addObject: monster]; 
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Marionette_3.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Marionette_3.plist"];
        
       // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
       frame2 = [framecache spriteFrameByName:@"Marionette001.png"];
        frame3= [framecache  spriteFrameByName:@"Marionette002.png"];
       frame4 = [framecache spriteFrameByName:@"Marionette003.png"];
       frame5 = [framecache spriteFrameByName:@"Marionette004.png"];
        frame6 = [framecache spriteFrameByName:@"Marionette005.png"];
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Medusa_3.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Medusa_3.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"Medusa002.png"];
        frame2 = [framecache spriteFrameByName:@"Medusa003.png"];
        frame3= [framecache  spriteFrameByName:@"Medusa004.png"];
        frame4 = [framecache spriteFrameByName:@"Medusa005.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+240,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];       
        ...
        [ a_monsters addObject: monster];
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Knogga_3.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Knogga_3.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"Knogga000.png"];
        frame2 = [framecache spriteFrameByName:@"Knogga001.png"];
        frame3= [framecache  spriteFrameByName:@"Knogga002.png"];
        frame4 = [framecache spriteFrameByName:@"Knogga003.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+290,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];       
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Baphomet_3.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Baphomet_3.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"baphomet000.png"];
        frame2 = [framecache spriteFrameByName:@"baphomet001.png"];
        frame3= [framecache  spriteFrameByName:@"baphomet002.png"];
        frame4 = [framecache spriteFrameByName:@"baphomet003.png"];
        frame5 = [framecache spriteFrameByName:@"baphomet004.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+310,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];       
...
{
    if ([a_monsters count] == 0)     [[CCDirector sharedDirector] replaceScene: [Level4 scene]];
