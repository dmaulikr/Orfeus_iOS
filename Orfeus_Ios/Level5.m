...
-(id) init
{
    ...
    if (self != nil)
    {
        ...
        monster.character=[CCSprite spriteWithFile:@"Knight.png"];   
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Knight.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame11 = [framecache spriteFrameByName:@"knight_of_abyss000.png"];

     frame1 = [framecache spriteFrameByName:@"knight_of_abyss001.png"];
        frame2 = [framecache spriteFrameByName:@"knight_of_abyss002.png"];
        frame3= [framecache  spriteFrameByName:@"knight_of_abyss003.png"];
        frame4 = [framecache spriteFrameByName:@"knight_of_abyss004.png"];
       ...
       [frames addObject:frame1];
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Wraith_dead.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Wraith_dead.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"wraith_dead000.png"];
        frame2 = [framecache spriteFrameByName:@"wraith_dead001.png"];
        frame3= [framecache  spriteFrameByName:@"wraith_dead002.png"];
        frame4 = [framecache spriteFrameByName:@"wraith_dead003.png"];
        frame5 = [framecache spriteFrameByName:@"wraith_dead004.png"];
        frame6 = [framecache spriteFrameByName:@"wraith_dead005.png"];
        frame11 = [framecache spriteFrameByName:@"wraith_dead006.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+50,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];    
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Marduk.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Marduk.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"Marduk000.png"];
        frame2 = [framecache spriteFrameByName:@"Marduk001.png"];
        frame3= [framecache  spriteFrameByName:@"Marduk002.png"];
        frame4 = [framecache spriteFrameByName:@"Marduk003.png"];
      frame5 = [framecache spriteFrameByName:@"Marduk001.png"];
        frame6 = [framecache spriteFrameByName:@"Marduk005.png"];
      ...
      [frames addObject:frame5];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+100,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];
        ...
        [ a_monsters addObject: monster]; 
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Wind_ghost.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Wind_ghost.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"wind_ghost000.png"];
        frame2 = [framecache spriteFrameByName:@"wind_ghost001.png"];
        frame3= [framecache  spriteFrameByName:@"wind_ghost002.png"];
        frame4 = [framecache spriteFrameByName:@"wind_ghost003.png"];
        frame5 = [framecache spriteFrameByName:@"wind_ghost004.png"];
        frame6 = [framecache spriteFrameByName:@"wind_ghost005.png"];
        frame11 = [framecache spriteFrameByName:@"wind_ghost006.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+150,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];       
        ...
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"Drake.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"Drake.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"Drake000.png"];
        frame2 = [framecache spriteFrameByName:@"Drake001.png"];
        frame3= [framecache  spriteFrameByName:@"Drake002.png"];
        frame4 = [framecache spriteFrameByName:@"Drake003.png"];
        frame5 = [framecache spriteFrameByName:@"Drake004.png"];
        frame6 = [framecache spriteFrameByName:@"Drake005.png"];
        frame11 = [framecache spriteFrameByName:@"Drake005.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+210,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];       
        ...
        [ a_monsters addObject: monster];
        monster =[[Monster alloc]init];
        monster.character=[CCSprite spriteWithFile:@"dracula.png"];   
        framecache =[ CCSpriteFrameCache sharedSpriteFrameCache];
        [ framecache addSpriteFramesWithFile:@"dracula.plist"];
        
        
        // orfeus  =[CCSprite spriteWithSpriteFrameName: @"orfeu1.png"];
        frame1 = [framecache spriteFrameByName:@"dracula000.png"];
        frame2 = [framecache spriteFrameByName:@"dracula001.png"];
        frame3= [framecache  spriteFrameByName:@"dracula002.png"];
        frame4 = [framecache spriteFrameByName:@"dracula003.png"];
        frame5 = [framecache spriteFrameByName:@"dracula004.png"];
        frame5 = [framecache spriteFrameByName:@"dracula005.png"];
        ...
        animate=[CCAnimate  actionWithAnimation: anim];
        repeat1 =[ CCRepeatForever actionWithAction: animate];
        monster.character.position = ccp (size.width+260,size.height*CCRANDOM_0_1()-30);
        [monster.character runAction: repeat1];
        monster.bonus = [CCSprite spriteWithFile:@"green_cross.png"];   
        [self addChild: monster.character];       
